...
public class Runner {
	...
	public static void main(String[] args) {
		...
		//Question 2:
		/*
		 * Step 1: The code itself written by the programmer in any environment or software he chooses
		 * 
		 * Step 2: Compile the code into a machine language so we can run and also convert the code to another language if we want
		 * 
		 * Step 3: Run the program from machine language so we can see the output
		 */
