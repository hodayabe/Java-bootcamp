...
public static int[] sumOfArrays(int[] longerArr, int[] shorterArr) {
		...
		int[] sumArray;
		int temp=0;
		sumArray = new int[shorterArr.length+longerArr.length];
		// summarize arrays
		int i = 0;
	...
	public static void putArraySumInLongerArrayAndPrint(int[] arr1, int[] arr2) {
...
//		System.out.println(isMirror(arr));
		...
		putArraySumInLongerArrayAndPrint(arr1, arr2);
